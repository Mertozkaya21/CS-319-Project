...
import styles from "./CoordinatorDashboardChat.module.css";
...
const groupsData = [
    ...
    },
    {
      ...
      name: "Advisors",
      members: [
        { id: 2, name: "Tony Soap", role: "Advisor" },
        { id: 4, name: "Jordan Nico", role: "Advisor" },
        { id: 7, name: "Lucy Graham", role: "Advisor" },
        { id: 14, name: "Ryan Lee", role: "Advisor" },
        { id: 16, name: "Ethan Brown", role: "Advisor" },
      ],
      lastMessageTime: "12:45 PM",
      lastMessagePreview: "Lorem ipsum dolor sit amet...",
      unreadCount: 2,
    },
    {
      ...
      name: "Trainees",
      members: [
        { id: 5, name: "Nadila Adja", role: "Trainee" },
        { id: 9, name: "Emily Jacobs", role: "Trainee" },
        { id: 13, name: "Sophia Martin", role: "Trainee" },
        { id: 20, name: "Daniel Harris", role: "Trainee" },
      ],
      lastMessageTime: "12:45 PM",
      lastMessagePreview: "Lorem ipsum dolor sit amet...",
      unreadCount: 2,
...
const groupChatHistory = {
  ...
  "Advisors": [
    { id: 1, type: "received", sender: "Tony Soap", content: "Just a reminder, the deadline for the report is Friday.", time: "11:15 AM" },
    { id: 2, type: "sent", sender: "Nabila A.", content: "Got it, Tony. Let me know if you need any help.", time: "11:20 AM" },
    { id: 3, type: "received", sender: "Jordan Nico", content: "Thanks, Nabila. I think we’re all set for now.", time: "11:22 AM" },
    { id: 4, type: "received", sender: "Lucy Graham", content: "Quick question, can we extend the review timeline by a day?", time: "11:25 AM" },
    { id: 5, type: "sent", sender: "Nabila A.", content: "I'll check and get back to you shortly.", time: "11:30 AM" },
    { id: 6, type: "received", sender: "Lucy Graham", content: "Quick question, can we extend the review timeline by a day?", time: "11:25 AM" },
    { id: 7, type: "received", sender: "Lucy Graham", content: "Somebody please answer.", time: "11:25 AM" },
    { id: 8, type: "received", sender: "Lucy Graham", content: "Please.", time: "11:25 AM" },
  ],
  "Trainees": [
    { id: 1, type: "received", sender: "Emily Jacobs", content: "Good morning, everyone! Just finished the training module.", time: "9:00 AM" },
    { id: 2, type: "received", sender: "Sophia Martin", content: "Same here! The module was really informative.", time: "9:05 AM" },
    { id: 3, type: "sent", sender: "Nabila A.", content: "Great to hear! Make sure to complete the feedback form.", time: "9:10 AM" },
    { id: 4, type: "received", sender: "Daniel Harris", content: "Quick question, is the form available online?", time: "9:15 AM" },
    { id: 5, type: "sent", sender: "Nabila A.", content: "Yes.", time: "9:20 AM" },
    { id: 6, type: "sent", sender: "Nabila A.", content: "I’ll share the link in this group shortly.", time: "9:20 AM" },
    { id: 7, type: "sent", sender: "Nabila A.", content: "Wait for my message.", time: "9:20 AM" },
    { id: 8, type: "sent", sender: "Nabila A.", content: "Thank you.", time: "9:20 AM" },
  ],
};
